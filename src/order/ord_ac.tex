...
\begin{lemma}
    ...
    \begin{proof}
        ...
        $I \subset U$ of $U$ the upper bound choice function applied to the
        ...
        \begin{enumerate}
            ...
            \item Strict lower bound selected:
                ...
                Assume $I$ is a proper initial segment of $U$ and $z \in U - I$.
                We have to show that $g(I)$ selects the least strict upper bound
                of $I$ in $U$ i.e. $g(I) \le z$.

                Since $U$ is the union of all towers there exists a tower $B$
                with $z \in B$.

                First we show that $I$ is an initial segment of $B$:
                \begin{enumerate}
                    \item $I \subseteq B$: Assume $x \in I$. We have to show
                        that $x \in B$.

                        There exists another tower $C$ with $x \in C$. According
                        to the comparability lemma~\ref{thmTowersComparable}
                        either $B$ is an initial segment of $C$ or $C$ is an
                        initial segment of $B$.

                        In the first case $x \in B$ is trivially valid.

                        If $B$ is an initial segment of $C$ then $z \in C$ is
                        valid. Since $x < z$ the element $x$ has to be in $B$.

                    \item Assume $x \in I$, $y \le x$ and $y \in B$. We have to
                        show $y \in I$.

                        Since $B \subseteq U$ and $I$ we have $y \in U$.
                        Furthermore $I$ an initial segment of $U$ an by
                        definition of an initial segment~\ref{defInitialSegment}
                        we have $y \in I$.
                \end{enumerate}

                Next we have to prove the $g(I)$ is the least strict upper bound
                of $I$ in $U$ i.e. $g(I) \le z$. We know already that $B$ is a
                tower contained in $U$, $I$ is a proper initial segment of $B$
                and $z \in B$. By definition of a tower~\ref{defTower} $g(I) \le
                z$ is valid.
        \end{enumerate}
    \end{proof}
\end{lemma}
...
\begin{theorem}
    \label{thmZornLemma}
    \emph{In a partial order $(P, \le)$ with choice function $f$ (and strict
    upper bound choice function $g$) Zorn's lemma is valid. The lemma says:
    If every chain has an upper bound then there exist a maximal element
    of the set $P$.}


    \begin{proof}
        We assume that every chain has an upper bound. Let $U$ be the union of
        all towers~\ref{defTower} which is by~\ref{thmTowerUnion} itself a tower
        and $x$ be an upper bound of $U$.

        \begin{enumerate}
            \item A strict upper bound of $U$ does not exist: Assume there exist
                strict upper bounds. $U$ is a proper initial segment of $U \cup
                \set{g(U)}$ i.e. $U \cup \set{g(U)}$ is a tower. This contradicts
                the fact that $U$ is the union of all towers.

            \item $x$ is the maximum of $U$: Since no strict upper bound of $U$
                exists and $x$ is an upper bound, $x \in U$ must be valid. I.e.
                $x$ is the maximum of $U$ by definition of a maximum.

            \item $x$ is a maximal element of the partially ordered set $P$: We
                have to show for all $y \in P$ with $x \le y$ the validity of $x
                = y$.

                We distinguish the cases $x = y$ and $x < y$. In the first case
                the goal is trivially valid. The second case leads to a
                contradiction because $y$ would be  a strict upper bound of $U$
                which cannot exist.
        \end{enumerate}
    \end{proof}
\end{theorem}
