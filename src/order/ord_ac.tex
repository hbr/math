...
\begin{lemma}
    ...
    \begin{proof}
        ...
        in steps by proving
            $A$ is an order ideal of $T$,
            $A$ is a proper order ideal of $T$,
            $g(A) \in S$
            and
        ...
        \begin{enumerate}
            \item $A$ is an order ideal of $T$: By definition $A$ is a subset of
            $T$. Let $x \in A$, $y \le x$ and $y \in T$. We have to show that $y
            \in A$ is valid. Since $A$ is downclosed in $T$ this is certainly
            valid.

            \item $A$ is a proper order ideal of $T$: By definition of $A$ the
            sets $A$ and $S$ are disjoint and their union is a subset of $T$.
            Since $S$ is not empty, $A$ is proper order ideal of $T$.
